...
import cost.manager.ViewModel.LoginDao;
...
public class loginView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(250, 345));
    ...
    private boolean Validate() {
        if (em.getText().trim().length() != 0 && pass.getText().trim().length() != 0) {
            return true;
        }
        return false;
    }
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (Validate()) {
            boolean b = login.Login(em.getText().trim().toLowerCase().toString(), pass.getText().trim().toLowerCase().toString());
            if (b) {
                   login.close();
                ...
                JOptionPane.showMessageDialog(null, "No User Found", "Warning", 3);
            }
